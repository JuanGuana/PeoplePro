...
<body>
  ...
  <main class="main-permiso">
    <h2 class="titulo-permiso">Editar Permiso</h2>
    <form class="formulario-permiso" action="/peoplepro/public/permiso/actualizar/<?= $data['permiso']['id'] ?>" method="POST">
      <label for="tipo">Tipo de permiso:</label>
      <input type="text" name="tipo" value="<?= htmlspecialchars($data['permiso']['tipo']) ?>" required>
